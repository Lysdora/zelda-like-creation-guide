...
- [🍏 Compter les objets dans le script (console uniquement)](./lesson/compter-objets-console-padawan.md)
...
- [Créer un système de Collectables dans Godot 4.4](./lesson/collectable_collection.md)
